...
class RegularizedLoss(torch.nn.Module):
    ...
    def __init__(self, base_loss, regularizer=None, reg_lambda=0.3,
                 start_epoch=0, ood_centers=None):
        super().__init__()
    ...
    @classmethod
    def from_cli(cls, loss_name, reg_lambda=0.3, start_epoch=0, ood_centers=None):
